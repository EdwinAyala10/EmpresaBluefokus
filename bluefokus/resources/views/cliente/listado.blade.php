                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="fv-row mb-5">
                                        ...
                                        <select name="tipo_doc_ed" id="tipo_doc_ed" class="form-control form-control-solid">
                                ...
                                <div class="col-lg-12 p-t-10">
                                    <button type="button" class="btn btn-lg btn-primary fw-bolder me-4 btn-success-degradate w-100 " id="editar-cliente" >Guardar</button>
                                </div>
                            </div>
                        </div>
                    </div>
